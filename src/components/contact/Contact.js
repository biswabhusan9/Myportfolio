...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    if (username === '') {
      ...
      setErrMsg('Please provide a valid phone number with country code and 10 digits!');
    } else if (email === '') {
      ...
      <div className='w-full'>
        <div className='w-full h-auto flex flex-col lgl:flex-row justify-between'>
          ...
          <div className='w-full lgl:w-[60%] h-full py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] flex flex-col gap-8 p-4 lgl:p-8 rounded-lg shadow-shadowOne'>
            <form className='w-full flex flex-col lgl:gap-6 gap-4 py-2 lgl:py-5'>
              {errMsg && (
              ...
              <div className='w-full flex flex-col lgl:flex-row gap-10'>
                ...
                <div className='w-full lgl:w-1/2 flex flex-col gap-4'>
                  ...
                  <input
                    ...
                    value={phoneNumber}
                    className={`${
                      errMsg === 'Please provide a valid phone number with country code and 10 digits!' && 'outline-designColor'
                    } contactInput`}
                    type='text'
                    placeholder='+1234567890' // Example placeholder for phone format
                  />
                </div>
              </div>
